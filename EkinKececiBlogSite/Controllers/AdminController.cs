...
using EkinKececiBlogSite.Models;
...
namespace EkinKececiBlogSite.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.BlogSayEN = db.BlogEN.Count();
            ViewBag.KategoriSayEN = db.KategoriEN.Count();
            ViewBag.MesajSayEN = db.KullaniciMesaj.Count();
            ViewBag.YorumSay = db.Yorums.Count();
            ViewBag.YorumSayEN = db.YorumEN.Count();
            ViewBag.YorumOnay = db.Yorums.Where(x => x.Onay == false).Count();
            ViewBag.YorumOnayEN = db.YorumEN.Where(x => x.Onay == false).Count();
        ...
        public ActionResult SifremiUnuttum(string eposta)
        {
            ...
            if (mail != null)
            {
                ...
                WebMail.UserName = "adminsifre@gmail.com";
                WebMail.Password = "adminsifre";
